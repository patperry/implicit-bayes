...
\begin{figure}
    \centering
    \subfigure[Relative Frobenius error versus $\bar \tau \eta$]{
      \makebox{\label{F:estimation-frob}\includegraphics[scale=0.6]{plots/estimation-frob-p100}}
    }
    \subfigure[Optimal regularization parameter (PLACEHOLDER)]{
      \makebox{\label{F:optimal-frob}\includegraphics[scale=0.6]{plots/estimation-spec-p100}}
    }
    %\caption{Analytical and emprical priors}
\end{figure}
