...
close to $\mathcal{L}$.
See the supplementary appendix~\ref{sxn:justification} for a more
...
We investigate these connections futher in the next section.
...
supplementary appendix~\ref{S:spectral-peformance}).
...
statistics (sorted values) of a Dirchlet distrubition on the
...
values of $s$ and $m$ (see supplementary appendix~\ref{S:frobenius-peformance}).
